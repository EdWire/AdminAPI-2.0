...
namespace EdFi.Ods.AdminApi.V2.Client.Extensions
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static void AddEdFiOdsAdminApiV2Client(this IServiceCollection services, Action<HostConfiguration> options)
        {
            HostConfiguration config = new(services);
            options(config);
            AddEdFiOdsAdminApiV2Client(services, config);
        }

        internal static void AddEdFiOdsAdminApiV2Client(IServiceCollection services, HostConfiguration host)
        {
            if (!host.HttpClientsAdded)
                host.AddEdFiOdsAdminApiV2ClientHttpClients();
