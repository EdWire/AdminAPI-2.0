...
inputSpec: ./docs/api-specifications/openapi-yaml/admin-api-2.2.1.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{C1034B96-DEF0-49FB-BB26-FBA47D72877E}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IV2ActionsGetApiResponse apiResponse = await api.V2ActionsGetAsync("todo");
            List<ActionModel>? model = apiResponse.Ok();
        }

        public static IHostBuilder CreateHostBuilder(string[] args) => Host.CreateDefaultBuilder(args)
          .ConfigureEdFiOdsAdminApiV2Client((context, services, options) =>
          {
              ...
              options.AddEdFiOdsAdminApiV2ClientHttpClients(client =>
              {
...
## Api Information
- appName: Admin API Documentation
- appVersion: v2
- appDescription: The Ed-Fi Admin API is a REST API-based administrative interface for managing vendors, applications, client credentials, and authorization rules for accessing an Ed-Fi API.
