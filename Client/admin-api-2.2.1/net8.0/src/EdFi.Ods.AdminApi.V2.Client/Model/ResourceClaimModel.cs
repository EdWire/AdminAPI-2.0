...
namespace EdFi.Ods.AdminApi.V2.Client.Model
{
    ...
    public partial class ResourceClaimModel : IValidatableObject
    {
        ...
        public int? ParentId { get { return this.ParentIdOption; } set { this.ParentIdOption = new(value); } }
        ...
        public List<ResourceClaimModel>? Children { get { return this.ChildrenOption; } set { this.ChildrenOption = new(value); } }
