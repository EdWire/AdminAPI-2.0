...
namespace EdFi.Ods.AdminApi.V2.Client.Api
{
    ...
    /// </summary>
    public interface IV2OdsInstanceDerivativesGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse, IOk<List<OdsInstanceDerivativeModel>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceDerivativesIdDeleteApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceDerivativesIdGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse, IOk<EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceDerivativeModel?>
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceDerivativesIdPutApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceDerivativesPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    public sealed partial class OdsInstanceDerivativesApi : IOdsInstanceDerivativesApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceDerivativesGetApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceDerivatives", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceDerivativesGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceDerivativesGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<OdsInstanceDerivativeModel>? result)
            {
                result = null;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceDerivativesIdDeleteApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceDerivatives/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceDerivativesIdDeleteApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceDerivativesIdDeleteApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceDerivativesIdGetApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceDerivatives/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceDerivativesIdGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceDerivativesIdGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceDerivativeModel? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceDerivativeModel>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceDerivativeModel? result)
            {
                result = null;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceDerivativesIdPutApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceDerivatives/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceDerivativesIdPutApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceDerivativesIdPutApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceDerivativesPostApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceDerivatives", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceDerivativesPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceDerivativesPostApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
