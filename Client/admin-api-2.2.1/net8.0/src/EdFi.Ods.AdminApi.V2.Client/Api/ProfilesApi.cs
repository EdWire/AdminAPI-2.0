...
namespace EdFi.Ods.AdminApi.V2.Client.Api
{
    ...
    /// </summary>
    public interface IV2ProfilesGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse, IOk<List<ProfileModel>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IV2ProfilesIdDeleteApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2ProfilesIdGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse, IOk<EdFi.Ods.AdminApi.V2.Client.Model.ProfileDetailsModel?>
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2ProfilesIdPutApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2ProfilesPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    public sealed partial class ProfilesApi : IProfilesApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2ProfilesGetApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/profiles", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2ProfilesGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2ProfilesGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<ProfileModel>? result)
            {
                result = null;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2ProfilesIdDeleteApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/profiles/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2ProfilesIdDeleteApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2ProfilesIdDeleteApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2ProfilesIdGetApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/profiles/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2ProfilesIdGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2ProfilesIdGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.Ods.AdminApi.V2.Client.Model.ProfileDetailsModel? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.Ods.AdminApi.V2.Client.Model.ProfileDetailsModel>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.Ods.AdminApi.V2.Client.Model.ProfileDetailsModel? result)
            {
                result = null;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2ProfilesIdPutApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/profiles/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2ProfilesIdPutApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2ProfilesIdPutApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2ProfilesPostApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/profiles", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2ProfilesPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2ProfilesPostApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
