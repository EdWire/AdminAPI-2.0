...
namespace EdFi.Ods.AdminApi.V2.Client.Api
{
    ...
    /// </summary>
    public interface IConnectRegisterPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IConnectTokenPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 400 BadRequest
        /// </summary>
    ...
    public sealed partial class ConnectApi : IConnectApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ConnectRegisterPostApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/connect/register", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class ConnectRegisterPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IConnectRegisterPostApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ConnectTokenPostApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/connect/token", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class ConnectTokenPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IConnectTokenPostApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
