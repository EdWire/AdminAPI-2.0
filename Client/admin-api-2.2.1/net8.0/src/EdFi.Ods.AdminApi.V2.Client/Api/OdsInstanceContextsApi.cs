...
namespace EdFi.Ods.AdminApi.V2.Client.Api
{
    ...
    /// </summary>
    public interface IV2OdsInstanceContextsGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse, IOk<List<OdsInstanceContextModel>?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceContextsIdDeleteApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceContextsIdGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse, IOk<EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceContextModel?>
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceContextsIdPutApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    /// </summary>
    public interface IV2OdsInstanceContextsPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 401 Unauthorized
        /// </summary>
    ...
    public sealed partial class OdsInstanceContextsApi : IOdsInstanceContextsApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceContextsGetApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceContexts", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceContextsGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceContextsGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<OdsInstanceContextModel>? result)
            {
                result = null;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceContextsIdDeleteApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceContexts/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceContextsIdDeleteApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceContextsIdDeleteApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceContextsIdGetApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceContexts/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceContextsIdGetApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceContextsIdGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceContextModel? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceContextModel>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out EdFi.Ods.AdminApi.V2.Client.Model.OdsInstanceContextModel? result)
            {
                result = null;
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceContextsIdPutApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceContexts/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceContextsIdPutApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceContextsIdPutApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2OdsInstanceContextsPostApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/odsInstanceContexts", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2OdsInstanceContextsPostApiResponse : EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse, IV2OdsInstanceContextsPostApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
