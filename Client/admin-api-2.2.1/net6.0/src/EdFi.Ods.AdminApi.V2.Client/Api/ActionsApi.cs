...
namespace EdFi.Ods.AdminApi.V2.Client.Api
{
    ...
    public interface IActionsApiSync : IApiAccessor
    {
        ...
        List<ActionModel> V2ActionsGet(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), int? id = default(int?), string? name = default(string?), int operationIndex = 0);
        ...
        /// <param name="name">Action name (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ActionModel&gt;</returns>
        ApiResponse<List<ActionModel>> V2ActionsGetWithHttpInfo(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), int? id = default(int?), string? name = default(string?), int operationIndex = 0);
    ...
    public interface IActionsApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ActionModel&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ActionModel>>> V2ActionsGetWithHttpInfoAsync(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), int? id = default(int?), string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ActionsApi : IActionsApi
    {
        ...
        /// <returns></returns>
        public ActionsApi(EdFi.Ods.AdminApi.V2.Client.Client.Configuration configuration)
        {
        ...
        public ActionsApi(EdFi.Ods.AdminApi.V2.Client.Client.ISynchronousClient client, EdFi.Ods.AdminApi.V2.Client.Client.IAsynchronousClient asyncClient, EdFi.Ods.AdminApi.V2.Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ActionModel&gt;</returns>
        public List<ActionModel> V2ActionsGet(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), int? id = default(int?), string? name = default(string?), int operationIndex = 0)
        {
            EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ActionModel>> localVarResponse = V2ActionsGetWithHttpInfo(offset, limit, orderBy, direction, id, name);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ActionModel&gt;</returns>
        public EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ActionModel>> V2ActionsGetWithHttpInfo(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), int? id = default(int?), string? name = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ActionsApi.V2ActionsGet";
            ...
            var localVarResponse = this.Client.Get<List<ActionModel>>("/v2/actions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("V2ActionsGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ActionModel>> localVarResponse = await V2ActionsGetWithHttpInfoAsync(offset, limit, orderBy, direction, id, name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ActionModel&gt;)</returns>
        public async System.Threading.Tasks.Task<EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ActionModel>>> V2ActionsGetWithHttpInfoAsync(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), int? id = default(int?), string? name = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ActionModel>>("/v2/actions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
