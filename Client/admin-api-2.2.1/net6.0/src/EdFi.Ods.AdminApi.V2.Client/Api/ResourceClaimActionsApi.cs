...
namespace EdFi.Ods.AdminApi.V2.Client.Api
{
    ...
    /// </summary>
    public interface IResourceClaimActionsApiSync : IApiAccessor
    {
        ...
        /// <returns>List&lt;ResourceClaimActionModel&gt;</returns>
        List<ResourceClaimActionModel> V2ResourceClaimActionsGet(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), string? resourceName = default(string?), int operationIndex = 0);
        ...
        /// <param name="resourceName"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ResourceClaimActionModel&gt;</returns>
        ApiResponse<List<ResourceClaimActionModel>> V2ResourceClaimActionsGetWithHttpInfo(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), string? resourceName = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IResourceClaimActionsApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ResourceClaimActionModel&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ResourceClaimActionModel>>> V2ResourceClaimActionsGetWithHttpInfoAsync(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), string? resourceName = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IResourceClaimActionsApi : IResourceClaimActionsApiSync, IResourceClaimActionsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ResourceClaimActionsApi : IResourceClaimActionsApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ResourceClaimActionsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ResourceClaimActionsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ResourceClaimActionsApi(EdFi.Ods.AdminApi.V2.Client.Client.Configuration configuration)
        {
        ...
        public ResourceClaimActionsApi(EdFi.Ods.AdminApi.V2.Client.Client.ISynchronousClient client, EdFi.Ods.AdminApi.V2.Client.Client.IAsynchronousClient asyncClient, EdFi.Ods.AdminApi.V2.Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ResourceClaimActionModel&gt;</returns>
        public List<ResourceClaimActionModel> V2ResourceClaimActionsGet(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), string? resourceName = default(string?), int operationIndex = 0)
        {
            EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ResourceClaimActionModel>> localVarResponse = V2ResourceClaimActionsGetWithHttpInfo(offset, limit, orderBy, direction, resourceName);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ResourceClaimActionModel&gt;</returns>
        public EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ResourceClaimActionModel>> V2ResourceClaimActionsGetWithHttpInfo(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), string? resourceName = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ResourceClaimActionsApi.V2ResourceClaimActionsGet";
            ...
            var localVarResponse = this.Client.Get<List<ResourceClaimActionModel>>("/v2/resourceClaimActions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("V2ResourceClaimActionsGet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ResourceClaimActionModel>> localVarResponse = await V2ResourceClaimActionsGetWithHttpInfoAsync(offset, limit, orderBy, direction, resourceName, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ResourceClaimActionModel&gt;)</returns>
        public async System.Threading.Tasks.Task<EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<List<ResourceClaimActionModel>>> V2ResourceClaimActionsGetWithHttpInfoAsync(int? offset = default(int?), int? limit = default(int?), string? orderBy = default(string?), string? direction = default(string?), string? resourceName = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<ResourceClaimActionModel>>("/v2/resourceClaimActions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
