...
namespace EdFi.Ods.AdminApi.V2.Client.Api
{
    ...
    public partial class ConnectApi : IConnectApi
    {
        ...
        /// <returns></returns>
        public ConnectApi(EdFi.Ods.AdminApi.V2.Client.Client.Configuration configuration)
        {
        ...
        public ConnectApi(EdFi.Ods.AdminApi.V2.Client.Client.ISynchronousClient client, EdFi.Ods.AdminApi.V2.Client.Client.IAsynchronousClient asyncClient, EdFi.Ods.AdminApi.V2.Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<Object> ConnectRegisterPostWithHttpInfo(string? clientId = default(string?), string? clientSecret = default(string?), string? displayName = default(string?), int operationIndex = 0)
        {
            ...
            if (clientId != null)
            {
                localVarRequestOptions.FormParameters.Add("ClientId", EdFi.Ods.AdminApi.V2.Client.Client.ClientUtils.ParameterToString(clientId)); // form parameter
            }
            if (clientSecret != null)
            {
                localVarRequestOptions.FormParameters.Add("ClientSecret", EdFi.Ods.AdminApi.V2.Client.Client.ClientUtils.ParameterToString(clientSecret)); // form parameter
            }
            if (displayName != null)
            {
                localVarRequestOptions.FormParameters.Add("DisplayName", EdFi.Ods.AdminApi.V2.Client.Client.ClientUtils.ParameterToString(displayName)); // form parameter
            }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<Object> ConnectTokenPostWithHttpInfo(String? clientId = default(String?), String? clientSecret = default(String?), String? grantType = default(String?), string? scope = default(string?), int operationIndex = 0)
        {
            EdFi.Ods.AdminApi.V2.Client.Client.RequestOptions localVarRequestOptions = new EdFi.Ods.AdminApi.V2.Client.Client.RequestOptions();
            ...
            if (clientId != null)
            {
                localVarRequestOptions.FormParameters.Add("client_id", EdFi.Ods.AdminApi.V2.Client.Client.ClientUtils.ParameterToString(clientId)); // form parameter
            }
            if (clientSecret != null)
            {
                localVarRequestOptions.FormParameters.Add("client_secret", EdFi.Ods.AdminApi.V2.Client.Client.ClientUtils.ParameterToString(clientSecret)); // form parameter
            }
            if (grantType != null)
            {
                localVarRequestOptions.FormParameters.Add("grant_type", EdFi.Ods.AdminApi.V2.Client.Client.ClientUtils.ParameterToString(grantType)); // form parameter
            }
            if (scope != null)
            {
                localVarRequestOptions.FormParameters.Add("scope", EdFi.Ods.AdminApi.V2.Client.Client.ClientUtils.ParameterToString(scope)); // form parameter
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<EdFi.Ods.AdminApi.V2.Client.Client.ApiResponse<Object>> ConnectTokenPostWithHttpInfoAsync(String? clientId = default(String?), String? clientSecret = default(String?), String? grantType = default(String?), string? scope = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
