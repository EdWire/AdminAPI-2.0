...
namespace EdFi.Ods.AdminApi.V2.Client.Model
{
    ...
    /// AddVendorRequest
    /// </summary>
    [DataContract(Name = "addVendorRequest")]
    public partial class AddVendorRequest : IEquatable<AddVendorRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AddVendorRequest(string company = default(string), string namespacePrefixes = default(string), string contactName = default(string), string contactEmailAddress = default(string))
        {
        ...
        {
            return this.Equals(input as AddVendorRequest);
        }

        /// <summary>
        /// Returns true if AddVendorRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddVendorRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddVendorRequest input)
        {
            if (input == null)
            {
                return false;
