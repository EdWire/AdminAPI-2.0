...
namespace EdFi.Ods.AdminApi.V2.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "editOdsInstanceDerivativeRequest")]
    public partial class EditOdsInstanceDerivativeRequest : IEquatable<EditOdsInstanceDerivativeRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public EditOdsInstanceDerivativeRequest(int odsInstanceId = default(int), string derivativeType = default(string), string connectionString = default(string))
        {
        ...
        {
            return this.Equals(input as EditOdsInstanceDerivativeRequest);
        }

        /// <summary>
        /// Returns true if EditOdsInstanceDerivativeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EditOdsInstanceDerivativeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditOdsInstanceDerivativeRequest input)
        {
            if (input == null)
            {
                return false;
