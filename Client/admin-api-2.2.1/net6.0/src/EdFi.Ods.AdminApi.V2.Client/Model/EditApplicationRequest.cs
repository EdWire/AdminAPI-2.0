...
namespace EdFi.Ods.AdminApi.V2.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "editApplicationRequest")]
    public partial class EditApplicationRequest : IEquatable<EditApplicationRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public EditApplicationRequest(string applicationName = default(string), int vendorId = default(int), string claimSetName = default(string), List<int> profileIds = default(List<int>), List<long> educationOrganizationIds = default(List<long>), List<int> odsInstanceIds = default(List<int>), bool? enabled = default(bool?))
        {
        ...
        {
            return this.Equals(input as EditApplicationRequest);
        }

        /// <summary>
        /// Returns true if EditApplicationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EditApplicationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditApplicationRequest input)
        {
            if (input == null)
            {
                return false;
