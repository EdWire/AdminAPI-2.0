...
namespace EdFi.Ods.AdminApi.V2.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addOdsInstanceContextRequest")]
    public partial class AddOdsInstanceContextRequest : IEquatable<AddOdsInstanceContextRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AddOdsInstanceContextRequest(int odsInstanceId = default(int), string contextKey = default(string), string contextValue = default(string))
        {
        ...
        {
            return this.Equals(input as AddOdsInstanceContextRequest);
        }

        /// <summary>
        /// Returns true if AddOdsInstanceContextRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AddOdsInstanceContextRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddOdsInstanceContextRequest input)
        {
            if (input == null)
            {
                return false;
