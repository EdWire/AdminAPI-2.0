...
namespace EdFi.Ods.AdminApi.Client.Api
{
    ...
    /// </summary>
    public interface IV2ResourceClaimActionsGetApiResponse : EdFi.Ods.AdminApi.Client.Client.IApiResponse, IOk<List<ResourceClaimActionModel>?>
    {
        /// <summary>
    ...
    public sealed partial class ResourceClaimActionsApi : IResourceClaimActionsApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        V2ResourceClaimActionsGetApiResponse apiResponseLocalVar = new V2ResourceClaimActionsGetApiResponse(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v2/resourceClaimActions", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class V2ResourceClaimActionsGetApiResponse : EdFi.Ods.AdminApi.Client.Client.ApiResponse, IV2ResourceClaimActionsGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// <returns></returns>
            public bool TryOk(out List<ResourceClaimActionModel>? result)
            {
                result = null;
