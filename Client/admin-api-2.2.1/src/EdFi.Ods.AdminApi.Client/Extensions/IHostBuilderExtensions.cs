...
namespace EdFi.Ods.AdminApi.Client.Extensions
{
    ...
    public static class IHostBuilderExtensions
    {
        ...
        public static IHostBuilder ConfigureEdFiOdsAdminApiClient(this IHostBuilder builder, Action<HostBuilderContext, IServiceCollection, HostConfiguration> options)
        {
            builder.ConfigureServices((context, services) => 
            {
                ...
                IServiceCollectionExtensions.AddEdFiOdsAdminApiClient(services, config);
            });
