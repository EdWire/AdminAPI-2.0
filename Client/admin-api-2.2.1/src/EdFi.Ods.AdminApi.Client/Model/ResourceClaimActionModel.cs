...
namespace EdFi.Ods.AdminApi.Client.Model
{
    ...
    public partial class ResourceClaimActionModel : IValidatableObject
    {
        ...
        public List<ActionForResourceClaimModel>? Actions { get { return this.ActionsOption; } set { this.ActionsOption = new Option<List<ActionForResourceClaimModel>?>(value); } }
