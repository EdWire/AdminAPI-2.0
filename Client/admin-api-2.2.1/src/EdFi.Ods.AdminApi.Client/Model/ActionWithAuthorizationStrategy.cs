...
namespace EdFi.Ods.AdminApi.Client.Model
{
    ...
    public partial class ActionWithAuthorizationStrategy : IValidatableObject
    {
        ...
        public List<AuthorizationStrategyModelForAction> AuthorizationStrategies { get { return this.AuthorizationStrategiesOption; } set { this.AuthorizationStrategiesOption = new Option<List<AuthorizationStrategyModelForAction>>(value); } }
